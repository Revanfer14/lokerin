                ...
                <div class="col">
                    <nav aria-label="breadcrumb" class="rounded-3 p-3 mb-4" style="background-color: white;">
                        <ol class="breadcrumb mb-0">
                            ...
                            <li class="breadcrumb-item"><a href="{{ route('admin.jobs') }}"
                                    style="color: var(--primary-blue);">Jobs</a></li>
                                ...
                                <div class="d-flex align-items-center mb-4">
                                    ...
                                    <div>
                                        <h3 class="fs-4 mb-0" style="color: var(--text-dark); font-weight: 600;">Edit Job
                                            Details</h3>
                                        <p class="text-muted mb-0" style="font-size: 14px;">Update job information and
                                            settings</p>
                                    </div>
                                </div>
                                <div class="row">
