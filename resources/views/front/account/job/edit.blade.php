                ...
                <div class="col">
                    <nav aria-label="breadcrumb" class="rounded-3 p-3 mb-4" style="background-color: white;">
                        <ol class="breadcrumb mb-0">
                            ...
                            <li class="breadcrumb-item"><a href="{{ route('account.myJobs') }}"
                                    style="color: var(--primary-blue);">My Jobs</a></li>
                        ...
                        <div class="card border-0 shadow mb-4" style="border-radius: 12px;">
                            <div class="card-body p-4">
                                <div class="d-flex align-items-center mb-4">
                                    ...
                                    <div>
                                        <h3 class="fs-4 mb-0" style="color: var(--text-dark); font-weight: 600;">Edit Job
                                            Details</h3>
                                        <p class="text-muted mb-0" style="font-size: 14px;">Update job information</p>
                                    </div>
                                </div>
                                <div class="row">
                            ...
                            <div class="card-footer p-4"
                                ...
                                <button type="submit" class="btn btn-primary"
                                    style="padding: 12px 32px; border-radius: 8px; font-weight: 600;"><i
                                        class="fas fa-save me-2"></i>Update Job</button>
                            </div>
                        </div>
                    </form>
